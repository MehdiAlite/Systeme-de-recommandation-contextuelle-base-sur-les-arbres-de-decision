...
public class MainTestID3 {
	...
	public static void main(String [] arg) throws IOException{
		...
		DecisionTree tree = algo.runAlgorithm(/*fileToPath(*/"Data2/tennis.txt"/*)*/, "play", " ");
		...
		String [] instance = {null,"rain","mild","high","strong"};
                String [] instance2={null,"sunny" , "hot", "mild" ,"weak"};
